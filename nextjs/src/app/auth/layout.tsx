...
export default function AuthLayout({
  ...
  const testimonials = [
    {
      quote:
        "CoStride transformed how our remote team stays accountable. The Google sign-in makes onboarding effortless and secure.",
      author: "Sarah Chen",
      role: "CTO, TechStart",
      avatar: "SC",
    },
    {
      quote:
        "The seamless Google authentication means our team can focus on collaboration instead of password management.",
    ...
    {
      quote:
        "Simple sign-in with Google, powerful team accountability features. It's the perfect combination for modern teams.",
      author: "Jessica Kim",
          ...
          <div className="space-y-6 max-w-lg">
            ...
            <div className="mt-8 text-center">
              <p className="text-primary-100 text-sm">
                Join thousands of teams building accountability with{" "}
                {productName}
              </p>
            </div>
          </div>
