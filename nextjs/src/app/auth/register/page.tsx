  ...
  return (
    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
      ...
      <div className="mt-6 text-center text-sm text-gray-500">
        ...
        <a href="/auth/login" className="text-primary-600 hover:text-primary-500 underline">
          Sign in
        </a>
      </div>
      ...
      <div className="mt-4 text-center text-xs text-gray-500">
        ...
        <a href="/legal/terms" className="text-primary-600 hover:text-primary-500 underline">
          Terms of Service
        </a>{' '}
        and{' '}
        <a href="/legal/privacy" className="text-primary-600 hover:text-primary-500 underline">
          Privacy Policy
        </a>
      </div>
    </div>
