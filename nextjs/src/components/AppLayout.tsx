...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "User Settings", href: "/app/user-settings", icon: Settings },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="lg:pl-64 flex flex-col h-screen">
        <div className="sticky top-0 z-10 flex items-center justify-between h-16 bg-white shadow-sm px-4 flex-shrink-0">
          <button
            onClick={toggleSidebar}
            className="lg:hidden text-gray-500 hover:text-gray-700"
          >
